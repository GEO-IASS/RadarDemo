...
public class RadarView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        firstDescriptionText = a.getString(R.styleable.RadarView_firstText);
        secondDescriptionText = a.getString(R.styleable.RadarView_secondText);
        thirdDescriptionText = a.getString(R.styleable.RadarView_thirdText);
        fourDescriptionText = a.getString(R.styleable.RadarView_fourText);
        fiveDescriptionText = a.getString(R.styleable.RadarView_fiveText);

        firstDescriptionDrawable = a.getDrawable(R.styleable.RadarView_firstDrawable);
        secondDescriptionDrawable = a.getDrawable(R.styleable.RadarView_secondDrawable);
        thirdDescriptionDrawable = a.getDrawable(R.styleable.RadarView_thirdDrawable);
        fourDescriptionDrawable = a.getDrawable(R.styleable.RadarView_fourDrawable);
        fiveDescriptionDrawable = a.getDrawable(R.styleable.RadarView_fiveDrawable);
        a.recycle();
        ...
        pentagonLinePathPaint.setColor(0xffc2ebd3);
